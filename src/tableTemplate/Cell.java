...
/**
 * a Cell class that defines any cell inside a table. It returns strings such
 * as: - "%12s" - "%-32s" - "%4d"
 */
public class Cell {

	/**
	 * The return value for the Cell after calculating all that needs to be
	 * calculated.
	 */
	private String cellString;
	/**
	 * The numeric value of the Cell. Returns a number used in the construction of
	 * cellString
	 */
	private int cellNumericValue;
	/**
	 * The default format type of a cell. It's value is derived from CellFormat
	 * enum. Change this variable to change the default behavior.
	 */
	 ...
	 * Change this variable to change the default behavior.
	 */
	...
	public Cell(CellSize size, CellFormat format, boolean invert) {
		this.cellBuilder(size, format, invert);
	}

	/**
	 * Default constructor. Uses the default values defined above.
	 */
	...
	private void cellBuilder(int size) {
		this.cellString = "%" + size + defaultCellFormat;
		this.cellNumericValue = size;
	}
