...
/**
 * Defines the possible configurations for a Row. 
 * - Separator: The character between each column of the table. 
...
public enum RowConfiguration {
	...
	/**
	 * Constructor to specify the value of enum varaibles of type String.
