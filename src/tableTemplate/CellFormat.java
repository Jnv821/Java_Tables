...
public enum CellFormat {
	 ...
	 * significand and an exponent. This conversion is not supported for the
	 * BigDecimal type despite the latter's being in the floating point argument
	 * category.
	 */
	a,
	/**
	...
	T,
	/**
	 * if the argument arg is null, then the result is "null". If arg implements
	 * Formattable, then arg.formatTo is invoked. Otherwise, the result is obtained
